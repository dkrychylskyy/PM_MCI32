  ...
  .factory('NotesDataService', function ($cordovaSQLite, $ionicPlatform) {
    ...
    return {
      createNote: function (note) {
        return $cordovaSQLite.execute(db, 'INSERT INTO T_CONTACTS (nom, prenom, codePostale, ville, email, portable, divers) VALUES(?, ?, ?, ?, ? ,?, ?)', [note.nom, note.prenom, note.codePostale, note.ville, note.email, note.portable, note.divers])
      },
